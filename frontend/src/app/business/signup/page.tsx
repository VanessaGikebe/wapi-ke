...
import { ApplicationWizard } from "@/components/business/application-wizard";
      ...
      <main className="mx-auto w-full max-w-container-max flex-1 px-margin-mobile py-12 md:px-margin-desktop">
        <div className="mx-auto mb-8 max-w-2xl">
          ...
          <p className="mt-2 font-body-lg text-body-lg text-on-surface-variant">
            Submit your details for verification. No account is created until an
            administrator approves your business.
          </p>
        </div>
        <ApplicationWizard />
      </main>
